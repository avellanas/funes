...
class AnnouncesControllerTest < ActionController::TestCase
  ...
  test "should create announce" do
    assert_difference('Announce.count') do
      post :create, announce: { expiration: @announce.expiration, popup: @announce.popup, text: @announce.text, title: @announce.title, window_height: @announce.window_height, window_width: @announce.window_width }
    end
  ...
  test "should update announce" do
    patch :update, id: @announce, announce: { expiration: @announce.expiration, popup: @announce.popup, text: @announce.text, title: @announce.title, window_height: @announce.window_height, window_width: @announce.window_width }
    assert_redirected_to announce_path(assigns(:announce))
  end
